...
All the requests that are using http protocol will have a port number of 80.
All the requests that are using https protocol will have a port number of 443.
